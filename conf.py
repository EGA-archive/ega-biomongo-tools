...
name='Marta Huertas' # Name of the person that does this operation.
method='Test' # Method used to obtain or modify the data (e.g. Raw data EGAPRO).
...
# ----------
update_field='genome' # Target field to be updated.
